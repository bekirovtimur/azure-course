...
$VaultName = 'timurbekirov-lab-rsv' #fetch automatically
$Subscription = 'EPM-RDSP' #fetch automatically
$ResourceGroup = 'timurbekirov-lab-rg' #fetch automatically
$SubscriptionId = 'd141e78e-f7a9-4013-bb34-623f58247d8b' #fetch automatically
